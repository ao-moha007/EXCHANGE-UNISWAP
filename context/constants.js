...
export const CONNECTING_CONTRACT = async (ADDRESS) => {
  ...
  try{
     ...
     console.log("Contract Address sigher ligne 41 :", signer);  // Debugging
     console.log("ADDRESS ligne 41 :", ADDRESS);
     ...
     const balance = await contract.balanceOf(userAddress);//TEST_ACCOUNT);
