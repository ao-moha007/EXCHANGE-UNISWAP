  ...
  return (
    <div className="scurity">
      <div className="icon-one">
        <img src="assets/img/scurity-vector-1.png" alt=""></img>
      </div>
      <div className="icon-two">
        <img src="assets/img/scurity-vector-2.png" alt=""></img>
      </div>
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-gl-10 text-center wow fadeInUp"
               ...
               data-wow-delay="0.2s">
                <div className="section-head">
                  ...
                  <h2 className="title">
                    ...
                    <p className="text">
                      And then you have to embrace risk. Make him your friend.
                    </p>
                </div>
               </div>
        </div>
